		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-7">
					<div class="info">
						<div class="info-item">
							<h2 class="title">TM THƯỜNG TRỰC BAN TỔ CHỨC</h2>
						...
						<div class="info-item">
							<h2 class="title">VỤ PHỔ BIẾN, PHÁP LUẬT GIÁO DỤC, BỘ TƯ PHÁP</h2>
							<p><i class="fa fa-address"></i> 58-60 Trần Phú, Ba Đình, Hà Nội</p>
						</div>
						<div class="info-item">
							<h2 class="title">CÔNG TY CP TẬP ĐOÀN GIÁO DỤC EGROUP</h2>
							<p><i class="fa fa-address"></i> Tầng 2, Tòa Nhà 25T1, Hoàng Đạo Thúy, Trung Hòa, Cầu Giấy, Hà Nội</p>
						</div>
					</div>
